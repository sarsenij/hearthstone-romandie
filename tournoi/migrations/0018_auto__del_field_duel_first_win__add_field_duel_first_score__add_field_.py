...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Duel.first_win'
        db.delete_column(u'tournoi_duel', 'first_win')

        # Adding field 'Duel.first_score'
        db.add_column(u'tournoi_duel', 'first_score',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)

        # Adding field 'Duel.second_score'
        db.add_column(u'tournoi_duel', 'second_score',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'Duel.first_win'
        db.add_column(u'tournoi_duel', 'first_win',
                      self.gf('django.db.models.fields.BooleanField')(default=True),
                      keep_default=False)

        # Deleting field 'Duel.first_score'
        db.delete_column(u'tournoi_duel', 'first_score')

        # Deleting field 'Duel.second_score'
        db.delete_column(u'tournoi_duel', 'second_score')
