...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Tournoi.inscrit'
        db.add_column(u'tournoi_tournoi', 'inscrit',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)


        # Changing field 'Tournoi.heure'
        db.alter_column(u'tournoi_tournoi', 'heure', self.gf('django.db.models.fields.TimeField')(null=True))

    def backwards(self, orm):
        # Deleting field 'Tournoi.inscrit'
        db.delete_column(u'tournoi_tournoi', 'inscrit')


        # Changing field 'Tournoi.heure'
        db.alter_column(u'tournoi_tournoi', 'heure', self.gf('django.db.models.fields.TimeField')(auto_now_add=True, null=True))
