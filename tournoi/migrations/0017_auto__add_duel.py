...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'Duel'
        db.create_table(u'tournoi_duel', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('first', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='first_duel', null=True, to=orm['auth.User'])),
            ('second', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='second_duel', null=True, to=orm['auth.User'])),
            ('first_win', self.gf('django.db.models.fields.BooleanField')(default=True)),
            ('valide', self.gf('django.db.models.fields.BooleanField')(default=False)),
        ))
        db.send_create_signal(u'tournoi', ['Duel'])


    def backwards(self, orm):
        # Deleting model 'Duel'
        db.delete_table(u'tournoi_duel')
    ...
    models = {
        ...
        u'tournoi.duel': {
            ...
            'first_win': ('django.db.models.fields.BooleanField', [], {'default': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
