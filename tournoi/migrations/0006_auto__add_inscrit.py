...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'tournoi_inscrit', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('tournoi', self.gf('django.db.models.fields.related.ForeignKey')(related_name='tournoi_inscrit', to=orm['tournoi.Tournoi'])),
            ('user', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'])),
        ))
        db.send_create_signal(u'tournoi', ['Inscrit'])


    def backwards(self, orm):
        # Deleting model 'Inscrit'
        db.delete_table(u'tournoi_inscrit')
