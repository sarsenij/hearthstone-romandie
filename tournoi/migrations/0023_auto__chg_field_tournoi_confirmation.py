...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Tournoi.confirmation'
        db.alter_column(u'tournoi_tournoi', 'confirmation', self.gf('django.db.models.fields.IntegerField')())

    def backwards(self, orm):

        # Changing field 'Tournoi.confirmation'
        db.alter_column(u'tournoi_tournoi', 'confirmation', self.gf('django.db.models.fields.BooleanField')())
    ...
    models = {
        ...
        u'tournoi.tournoi': {
            ...
            'confirmation': ('django.db.models.fields.IntegerField', [], {'default': '0'}),
