...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column(u'tournoi_match', 'score_first', self.gf('django.db.models.fields.CharField')(max_length=2, null=True))

        # Changing field 'Match.score'
        db.alter_column(u'tournoi_match', 'score', self.gf('django.db.models.fields.CharField')(max_length=2, null=True))

        # Changing field 'Match.score_second'
        db.alter_column(u'tournoi_match', 'score_second', self.gf('django.db.models.fields.CharField')(max_length=2, null=True))
    ...
    def backwards(self, orm):
        ...
        # Changing field 'Match.score'
        db.alter_column(u'tournoi_match', 'score', self.gf('django.db.models.fields.IntegerField')(null=True))
