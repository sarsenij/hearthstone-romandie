...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Match.poule'
        db.add_column(u'tournoi_match', 'poule',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)

        # Adding field 'Match.loser_bracket'
        db.add_column(u'tournoi_match', 'loser_bracket',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Match.poule'
        db.delete_column(u'tournoi_match', 'poule')

        # Deleting field 'Match.loser_bracket'
        db.delete_column(u'tournoi_match', 'loser_bracket')
