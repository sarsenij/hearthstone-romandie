...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Tournoi.duel'
        db.add_column(u'tournoi_tournoi', 'duel',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Tournoi.duel'
        db.delete_column(u'tournoi_tournoi', 'duel')
    ...
    models = {
        ...
        u'tournoi.tournoi': {
            ...
            'duel': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
