...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Match.score_first_by_first'
        db.delete_column(u'tournoi_match', 'score_first_by_first')

        # Deleting field 'Match.score_first_by_second'
        db.delete_column(u'tournoi_match', 'score_first_by_second')

        # Deleting field 'Match.score_second_by_second'
        db.delete_column(u'tournoi_match', 'score_second_by_second')

        # Deleting field 'Match.score_second_by_first'
        db.delete_column(u'tournoi_match', 'score_second_by_first')

        # Adding field 'Match.score'
        db.add_column(u'tournoi_match', 'score',
                      self.gf('django.db.models.fields.IntegerField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'Match.score_first_by_first'
        db.add_column(u'tournoi_match', 'score_first_by_first',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)

        # Adding field 'Match.score_first_by_second'
        db.add_column(u'tournoi_match', 'score_first_by_second',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)

        # Adding field 'Match.score_second_by_second'
        db.add_column(u'tournoi_match', 'score_second_by_second',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)

        # Adding field 'Match.score_second_by_first'
        db.add_column(u'tournoi_match', 'score_second_by_first',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)

        # Deleting field 'Match.score'
        db.delete_column(u'tournoi_match', 'score')
    ...
    models = {
        ...
        u'tournoi.match': {
            ...
            'score_first': ('django.db.models.fields.IntegerField', [], {'null': 'True', 'blank': 'True'}),
            'score_second': ('django.db.models.fields.IntegerField', [], {'null': 'True', 'blank': 'True'}),
