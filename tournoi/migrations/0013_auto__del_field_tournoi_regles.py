...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Tournoi.regles'
        db.delete_column(u'tournoi_tournoi', 'regles')


    def backwards(self, orm):
        # Adding field 'Tournoi.regles'
        db.add_column(u'tournoi_tournoi', 'regles',
                      self.gf('django.db.models.fields.TextField')(default='ttt'),
                      keep_default=False)
