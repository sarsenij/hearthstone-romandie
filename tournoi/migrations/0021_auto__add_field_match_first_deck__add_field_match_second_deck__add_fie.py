...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Match.first_deck'
        db.add_column(u'tournoi_match', 'first_deck',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=20),
                      keep_default=False)

        # Adding field 'Match.second_deck'
        db.add_column(u'tournoi_match', 'second_deck',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=20),
                      keep_default=False)

        # Adding field 'Match.conquest_check'
        db.add_column(u'tournoi_match', 'conquest_check',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'Tournoi.conquest'
        db.add_column(u'tournoi_tournoi', 'conquest',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Match.first_deck'
        db.delete_column(u'tournoi_match', 'first_deck')

        # Deleting field 'Match.second_deck'
        db.delete_column(u'tournoi_match', 'second_deck')

        # Deleting field 'Match.conquest_check'
        db.delete_column(u'tournoi_match', 'conquest_check')

        # Deleting field 'Tournoi.conquest'
        db.delete_column(u'tournoi_tournoi', 'conquest')
    ...
    models = {
        ...
        u'tournoi.match': {
            ...
            'first_deck': ('django.db.models.fields.CharField', [], {'default': "''", 'max_length': '20'}),
            ...
            'second_deck': ('django.db.models.fields.CharField', [], {'default': "''", 'max_length': '20'}),
