...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Topic.postit'
        db.add_column(u'pybb_topic', 'postit',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'Topic.close'
        db.add_column(u'pybb_topic', 'close',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Topic.postit'
        db.delete_column(u'pybb_topic', 'postit')

        # Deleting field 'Topic.close'
        db.delete_column(u'pybb_topic', 'close')
