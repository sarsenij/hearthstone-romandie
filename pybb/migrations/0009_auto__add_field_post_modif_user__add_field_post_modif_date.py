...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Post.modif_user'
        db.add_column(u'pybb_post', 'modif_user',
                      self.gf('django.db.models.fields.related.ForeignKey')(related_name='post_modif', null=True, to=orm['auth.User']),
                      keep_default=False)

        # Adding field 'Post.modif_date'
        db.add_column(u'pybb_post', 'modif_date',
                      self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime.now, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Post.modif_user'
        db.delete_column(u'pybb_post', 'modif_user_id')

        # Deleting field 'Post.modif_date'
        db.delete_column(u'pybb_post', 'modif_date')
