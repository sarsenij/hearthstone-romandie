...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column(u'pybb_post', 'deleted',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'Post.deleted_by'
        db.add_column(u'pybb_post', 'deleted_by',
                      self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='post_deleted', null=True, to=orm['auth.User']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Post.deleted'
        db.delete_column(u'pybb_post', 'deleted')

        # Deleting field 'Post.deleted_by'
        db.delete_column(u'pybb_post', 'deleted_by_id')
