...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Post.locked'
        db.add_column(u'pybb_post', 'locked',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Post.locked'
        db.delete_column(u'pybb_post', 'locked')
    ...
    models = {
        ...
        u'pybb.post': {
            ...
            'modif_user': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'post_modif'", 'null': 'True', 'to': u"orm['auth.User']"}),
