...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Forum.staff'
        db.add_column(u'pybb_forum', 'staff',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'Topic.deleted'
        db.add_column(u'pybb_topic', 'deleted',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'Topic.staff'
        db.add_column(u'pybb_topic', 'staff',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Forum.staff'
        db.delete_column(u'pybb_forum', 'staff')

        # Deleting field 'Topic.deleted'
        db.delete_column(u'pybb_topic', 'deleted')

        # Deleting field 'Topic.staff'
        db.delete_column(u'pybb_topic', 'staff')
