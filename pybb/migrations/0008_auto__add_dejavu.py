...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'Dejavu'
        db.create_table(u'pybb_dejavu', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('compte', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'])),
            ('forum', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['pybb.Forum'])),
            ('topic', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['pybb.Topic'])),
            ('post', self.gf('django.db.models.fields.IntegerField')(default=0)),
        ))
        db.send_create_signal(u'pybb', ['Dejavu'])


    def backwards(self, orm):
        # Deleting model 'Dejavu'
        db.delete_table(u'pybb_dejavu')
