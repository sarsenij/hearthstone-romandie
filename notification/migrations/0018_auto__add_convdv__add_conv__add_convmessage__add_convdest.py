...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'ConvDV'
        db.create_table(u'notification_convdv', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('user', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'])),
            ('conv', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['notification.Conv'])),
            ('message', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['notification.ConvMessage'], null=True, blank=True)),
        ))
        db.send_create_signal(u'notification', ['ConvDV'])

        # Adding model 'Conv'
        db.create_table(u'notification_conv', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('exist', self.gf('django.db.models.fields.BooleanField')(default=True)),
        ))
        db.send_create_signal(u'notification', ['Conv'])

        # Adding model 'ConvMessage'
        db.create_table(u'notification_convmessage', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('conv', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['notification.Conv'])),
        ...
        db.send_create_signal(u'notification', ['ConvMessage'])

        # Adding model 'ConvDest'
        db.create_table(u'notification_convdest', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('conv', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['notification.Conv'])),
            ('user', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'])),
        ))
        db.send_create_signal(u'notification', ['ConvDest'])


    def backwards(self, orm):
        # Deleting model 'ConvDV'
        db.delete_table(u'notification_convdv')

        # Deleting model 'Conv'
        db.delete_table(u'notification_conv')

        # Deleting model 'ConvMessage'
        db.delete_table(u'notification_convmessage')

        # Deleting model 'ConvDest'
        db.delete_table(u'notification_convdest')
