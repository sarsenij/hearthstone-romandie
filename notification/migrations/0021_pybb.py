...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Dejavu.new'
        db.add_column(u'notification_dejavu', 'new',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Dejavu.new'
        db.delete_column(u'notification_dejavu', 'new')
    ...
    models = {
        ...
        u'notification.convdv': {
            ...
            'mew': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
            'user': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['auth.User']"})
        },
