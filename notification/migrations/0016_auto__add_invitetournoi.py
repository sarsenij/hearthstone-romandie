...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'InviteTournoi'
        db.create_table(u'notification_invitetournoi', (
        ...
        db.send_create_signal(u'notification', ['InviteTournoi'])


    def backwards(self, orm):
        # Deleting model 'InviteTournoi'
        db.delete_table(u'notification_invitetournoi')
