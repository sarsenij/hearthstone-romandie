...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('notification_notification', (
            ...
            ('not_type', self.gf('django.db.models.fields.CharField')(max_length=125)),
            ('vue', self.gf('django.db.models.fields.BooleanField')(default=False)),
            ('date', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime(2014, 4, 12, 0, 0))),
        ))
