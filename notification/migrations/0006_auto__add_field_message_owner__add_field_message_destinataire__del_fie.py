...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Message.owner'
        db.add_column('notification_message', 'owner',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=1, related_name='blabla', to=orm['profil.Profil']),
                      keep_default=False)

        # Adding field 'Message.destinataire'
        db.add_column('notification_message', 'destinataire',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=1, related_name='blibli', to=orm['profil.Profil']),
                      keep_default=False)

        # Deleting field 'MessageTitre.owner'
        db.delete_column('notification_messagetitre', 'owner_id')

        # Deleting field 'MessageTitre.destinataire'
        db.delete_column('notification_messagetitre', 'destinataire_id')


    def backwards(self, orm):
        # Deleting field 'Message.owner'
        db.delete_column('notification_message', 'owner_id')

        # Deleting field 'Message.destinataire'
        db.delete_column('notification_message', 'destinataire_id')

        # Adding field 'MessageTitre.owner'
        db.add_column('notification_messagetitre', 'owner',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=1, related_name='blabla', to=orm['profil.Profil']),
                      keep_default=False)

        # Adding field 'MessageTitre.destinataire'
        db.add_column('notification_messagetitre', 'destinataire',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=1, related_name='blibli', to=orm['profil.Profil']),
                      keep_default=False)
