...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'MessageTitre.edit'
        db.add_column(u'notification_messagetitre', 'edit',
                      self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime.now),
                      keep_default=False)

        # Adding field 'MessageVu.messagetitre'
        db.add_column(u'notification_messagevu', 'messagetitre',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['notification.MessageTitre'], null=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'MessageTitre.edit'
        db.delete_column(u'notification_messagetitre', 'edit')

        # Deleting field 'MessageVu.messagetitre'
        db.delete_column(u'notification_messagevu', 'messagetitre_id')
