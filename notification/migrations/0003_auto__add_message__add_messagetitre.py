...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('notification_message', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('titre', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['notification.MessageTitre'])),
            ('owner', self.gf('django.db.models.fields.related.ForeignKey')(related_name='blabla', to=orm['profil.Profil'])),
            ('destinataire', self.gf('django.db.models.fields.related.ForeignKey')(related_name='blibli', to=orm['profil.Profil'])),
            ('message', self.gf('django.db.models.fields.TextField')()),
        ))
        db.send_create_signal('notification', ['Message'])

        # Adding model 'MessageTitre'
        db.create_table('notification_messagetitre', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('titre', self.gf('django.db.models.fields.CharField')(max_length=250)),
        ))
        db.send_create_signal('notification', ['MessageTitre'])


    def backwards(self, orm):
        # Deleting model 'Message'
        db.delete_table('notification_message')

        # Deleting model 'MessageTitre'
        db.delete_table('notification_messagetitre')
