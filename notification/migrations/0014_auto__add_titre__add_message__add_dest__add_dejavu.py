...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'Titre'
        db.create_table(u'notification_titre', (
        ...
        db.send_create_signal(u'notification', ['Titre'])

        # Adding model 'Message'
        db.create_table(u'notification_message', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('created', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime.now)),
            ('titre', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['notification.Titre'])),
        ...
        # Adding model 'Dest'
        db.create_table(u'notification_dest', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('titre', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['notification.Titre'])),
            ('dest', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'])),
        ))
        db.send_create_signal(u'notification', ['Dest'])

        # Adding model 'Dejavu'
        db.create_table(u'notification_dejavu', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('compte', self.gf('django.db.models.fields.related.ForeignKey')(related_name='message_dejavu', to=orm['auth.User'])),
            ('titre', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['notification.Titre'])),
            ('message', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['notification.Message'])),
        ))
        db.send_create_signal(u'notification', ['Dejavu'])


    def backwards(self, orm):
        # Deleting model 'Titre'
        db.delete_table(u'notification_titre')

        # Deleting model 'Message'
        db.delete_table(u'notification_message')

        # Deleting model 'Dest'
        db.delete_table(u'notification_dest')

        # Deleting model 'Dejavu'
        db.delete_table(u'notification_dejavu')
