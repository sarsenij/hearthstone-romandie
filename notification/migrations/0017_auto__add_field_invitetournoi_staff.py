...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'InviteTournoi.staff'
        db.add_column(u'notification_invitetournoi', 'staff',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'InviteTournoi.staff'
        db.delete_column(u'notification_invitetournoi', 'staff')
