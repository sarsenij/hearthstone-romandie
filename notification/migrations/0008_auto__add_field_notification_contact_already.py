...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Notification.contact_already'
        db.add_column('notification_notification', 'contact_already',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Notification.contact_already'
        db.delete_column('notification_notification', 'contact_already')
