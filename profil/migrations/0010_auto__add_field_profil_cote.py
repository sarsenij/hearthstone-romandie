...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Profil.cote'
        db.add_column(u'profil_profil', 'cote',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Profil.cote'
        db.delete_column(u'profil_profil', 'cote')
    ...
    models = {
        ...
        u'profil.profil': {
            ...
            'cote': ('django.db.models.fields.IntegerField', [], {'default': '0'}),
