...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Profil.email_sent'
        db.add_column(u'profil_profil', 'email_sent',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'Profil.email_fail'
        db.add_column(u'profil_profil', 'email_fail',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'Profil.email_verified'
        db.add_column(u'profil_profil', 'email_verified',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'Profil.email_code'
        db.add_column(u'profil_profil', 'email_code',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)

        # Adding field 'Profil.email_failcode'
        db.add_column(u'profil_profil', 'email_failcode',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'Profil.step_settings'
        db.add_column(u'profil_profil', 'step_settings',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'Profil.alert_forum'
        db.add_column(u'profil_profil', 'alert_forum',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'Profil.alert_contact'
        db.add_column(u'profil_profil', 'alert_contact',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'Profil.alert_tournoi'
        db.add_column(u'profil_profil', 'alert_tournoi',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Profil.email_sent'
        db.delete_column(u'profil_profil', 'email_sent')

        # Deleting field 'Profil.email_fail'
        db.delete_column(u'profil_profil', 'email_fail')

        # Deleting field 'Profil.email_verified'
        db.delete_column(u'profil_profil', 'email_verified')

        # Deleting field 'Profil.email_code'
        db.delete_column(u'profil_profil', 'email_code')

        # Deleting field 'Profil.email_failcode'
        db.delete_column(u'profil_profil', 'email_failcode')

        # Deleting field 'Profil.step_settings'
        db.delete_column(u'profil_profil', 'step_settings')

        # Deleting field 'Profil.alert_forum'
        db.delete_column(u'profil_profil', 'alert_forum')

        # Deleting field 'Profil.alert_contact'
        db.delete_column(u'profil_profil', 'alert_contact')

        # Deleting field 'Profil.alert_tournoi'
        db.delete_column(u'profil_profil', 'alert_tournoi')
