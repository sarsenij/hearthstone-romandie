...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Profil.news'
        db.add_column(u'profil_profil', 'news',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)

        # Adding field 'Profil.sound'
        db.add_column(u'profil_profil', 'sound',
                      self.gf('django.db.models.fields.BooleanField')(default=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Profil.news'
        db.delete_column(u'profil_profil', 'news')

        # Deleting field 'Profil.sound'
        db.delete_column(u'profil_profil', 'sound')
