...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Profil.webtv'
        db.add_column(u'profil_profil', 'webtv',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


        # Changing field 'Profil.email'
        db.alter_column(u'profil_profil', 'email', self.gf('django.db.models.fields.CharField')(max_length=125, null=True))

    def backwards(self, orm):
        # Deleting field 'Profil.webtv'
        db.delete_column(u'profil_profil', 'webtv')


        # Changing field 'Profil.email'
        db.alter_column(u'profil_profil', 'email', self.gf('django.db.models.fields.CharField')(default='', max_length=125))
